...
console.log(`this is first name _${firstName}_`);

console.log(`this is midlle name _${middleName}_`);

console.log(`this is last name _${lastName}_`);
...
// *********************************  Real Capitalization execise: *******************************

// let theName = "tobIAS";

// let sameName = theName[0].toUpperCase() + theName.substring(1).toLowerCase();
